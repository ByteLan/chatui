...
import useTypedEffect from './hooks/useTypedEffect.ts';
import useTypingConfig from './hooks/useTypingConfig.ts';
import type { BubbleContentType, BubbleProps } from './interface.ts';
