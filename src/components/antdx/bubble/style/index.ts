...
import type { FullToken, GenerateStyle, GetDefaultToken } from '../../theme/cssinjs-utils.ts';
import { genStyleHooks } from '../../theme/genStyleUtils.ts';
import { genShapeStyle, genVariantStyle } from './content.ts';
import genBubbleListStyle from './list.ts';
