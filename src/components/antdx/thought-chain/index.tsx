...
import useCollapsible from './hooks/useCollapsible.ts';
import useStyle from './style';

import useXComponentConfig from '../_util/hooks/use-x-component-config.ts';
import ThoughtChainNode, { ThoughtChainNodeContext } from './Item.tsx';

import type { ConfigProviderProps } from 'antd';
import type { ThoughtChainItem } from './Item.tsx';
import type { Collapsible } from './hooks/useCollapsible.ts';
