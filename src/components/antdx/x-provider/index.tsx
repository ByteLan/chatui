...
import XProviderContext from './context.ts';
import useXProviderContext, { defaultPrefixCls } from './hooks/use-x-provider-context.ts';

import type { ConfigProviderProps as AntdConfigProviderProps } from 'antd/es/config-provider';
import type { XProviderProps } from './context.ts';
